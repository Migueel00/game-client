...
import { initLucretiaProyectile, initLucretiaProyectileDown, initLucretiaProyectileUp, initLucretiaProyectileLeft, initArcherProyectile, initArcherProyectileLeft, initKnight2, 
initKnightShield, initKnightArcher, initLifeIcon, createFireParticle, initFireworks} from "./initialize.js";
...
function updateLucretiaProyectileUp(sprite){
    ...
    // Al colisionar saca el sprite del array de sprites
    calculateCollisionSpriteAndRemove(sprite);

    if(sprite.isCollidingWithSprite){
...
function updateLucretiaProyectileDown(sprite){
...
function updateLucretiaProyectileLeft(sprite){
...
function updateLucretiaProyectile(sprite){
    ...
    // al colisionar con sprite enemigo cambia de estado off
    if(sprite.isCollidingWithSprite){
        sprite.state = State.OFF;
    }
}
...
function updateSprite(sprite){
    ...
    switch(type){
        ...
        case SpriteID.FIRE:
            updateFire(sprite);
            break;
        case SpriteID.LUCRETIA_PROYECTILE_RIGHT:
            updateLucretiaProyectile(sprite);
            break;
        case SpriteID.LUCRETIA_PROYECTILE_UP:
            updateLucretiaProyectileUp(sprite);
            break;
        case SpriteID.LUCRETIA_PROYECTILE_DOWN:
            updateLucretiaProyectileDown(sprite);
            break;
        case SpriteID.LUCRETIA_PROYECTILE_LEFT:
            updateLucretiaProyectileLeft(sprite);
            break;
