...
export const SpriteID = {
    ...
    C_KEY:      16,
    LIFE_ICON:                  17,
    LUCRETIA_PROYECTILE_RIGHT:  19,
    LUCRETIA_PROYECTILE_LEFT:   20,
    LUCRETIA_PROYECTILE_UP:     21,
    LUCRETIA_PROYECTILE_DOWN:   22,
    ARCHER_PROYECTILE:          23,
    ARCHER_PROYECTILE_LEFT:     24
...
export const State = {
    ...
    //PROYECTILES
    LUCRETIA_PROYECTILE_RIGHT: 0,
    LUCRETIA_PROYECTILE_LEFT:  0,
    LUCRETIA_PROYECTILE_UP:    0,
    LUCRETIA_PROYECTILE_DOWN:  0,
