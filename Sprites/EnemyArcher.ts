...
export default class EnemyArcher extends Sprite {
    ...
    private collisionBetweenArcherAndTree(): void {
    ...
    private isCollidingWithObstacleTreeAt(xPos: number, yPos: number, ObstacleId: number[], mapObstaclesId: number[]): boolean {
        const brickSize = globals.obstacles.imageSet.xGridSize;
